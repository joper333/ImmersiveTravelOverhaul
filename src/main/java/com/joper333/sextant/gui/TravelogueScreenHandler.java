...
public class TravelogueScreenHandler extends AbstractRecipeScreenHandler<CraftingInventory> {
    ...
    public TravelogueScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, ScreenHandlerContext.EMPTY);
    }

    public TravelogueScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
